export default [
  {
    label: "能耗图标",
    list: [  " iconfont el-icon-louceng",
    " iconfont el-icon-louceng1",
    " iconfont el-icon-huaxiangduibifenxi",
    " iconfont el-icon-wxbbaobiao",
    " iconfont el-icon-zonglan01",
    " iconfont el-icon-baobiao",
    " iconfont el-icon-fenlei1",
    " iconfont el-icon-baobiao1",
    " iconfont el-icon-yewan",
    " iconfont el-icon-contrast_curve",
    " iconfont el-icon-shujuduibi1",
    " iconfont el-icon-duibifenxi",
    " iconfont el-icon-chengchangduibi",
    " iconfont el-icon-baobiao2",
    " iconfont el-icon-tianqishuijueyewanshuijue",
    " iconfont el-icon-kehuzonglan",

    " iconfont el-icon-tianqishuijueyewanshuijue",
    " iconfont el-icon-zonglan2",
    " iconfont el-icon-houtaizonglan",
    " iconfont el-icon-zonglan1",
    " iconfont el-icon-baobiao",
    " iconfont el-icon-houtaizonglan",
    " iconfont el-icon-shujuduibi1",
    " iconfont el-icon-baobiao1",

    " iconfont el-icon-shijian",
    " iconfont el-icon-yuce",
    " iconfont el-icon-tongjiyuce",
    " iconfont el-icon-loufang",
    " iconfont el-icon-louceng",
   " iconfont el-icon-fangjianshu",],
  },
  {
    label: "通用图标",
    list: [
