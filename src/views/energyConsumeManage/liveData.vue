  ...
  <div>
    ...
    >
      ...
      <el-col :span="6" :offset="12">
        ...
        <ExPortButton exportName='实时数据' tableId='#table'></ExPortButton>
      </el-col>
    </el-row>
    <el-table :data="realTimeData" border style="width: 100%; margin: 10px 0" id='table'>
    ...
    getRealTimeData( ) {
      this.$axios
        .get("/api/vkie/consumption/realTimeData", {
          params: {
            meterType: this.meterType ? this.meterType : 1 ,
